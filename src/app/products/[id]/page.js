    ...
    return (
      <main className="min-h-screen pt-32 pb-20 flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <Link href="/products" className="text-brand-600 font-medium hover:underline">← Back to Products</Link>
        </div>
      </main>
    );
  }
  ...
  return (
    <main className="min-h-screen pt-28 sm:pt-32 pb-16 sm:pb-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        {/* Breadcrumb */}
        <Link href="/products" className="inline-flex items-center gap-1.5 text-sm text-dark-500 hover:text-brand-600 transition-colors mb-6 sm:mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3.5 bg-green-500 text-white rounded-2xl font-semibold hover:bg-green-600 transition-colors text-sm sm:text-base"
              >
        ...
        <section className="mb-16 sm:mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Review Form */}
            <div>
              <ReviewForm productId={product.id} onReviewAdded={() => loadReviews(product.id)} />
            </div>
          </div>
        </section>
