    ...
    <section className="relative min-h-[80vh] sm:min-h-[85vh] flex items-center bg-dark-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24 w-full relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          {/* Visual - Premium Tech Illustration */}
          <motion.div
          ...
          >
            <div className="relative">
              <div className="w-56 h-56 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-white/10 to-white/5 rounded-[2rem] sm:rounded-[2.5rem] border border-white/10 backdrop-blur-sm flex items-center justify-center shadow-2xl overflow-hidden">
                <img
                  src="/hero-illustration.svg"
                  alt="Premium tech devices - phone, laptop, watch, earbuds"
              ...
              <motion.div
                ...
                className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-white rounded-xl sm:rounded-2xl px-3 sm:px-5 py-2 sm:py-3 shadow-xl"
              >
                <p className="text-[10px] sm:text-xs text-dark-500 font-medium">Starting from</p>
                <p className="text-base sm:text-xl font-bold text-dark-900">₦35,000</p>
              </motion.div>
              {/* Floating Shipping Badge */}
              <motion.div
                animate={{ y: [0, 8, 0] }}
                transition={{ duration: 4, repeat: Infinity, delay: 1 }}
                className="absolute -bottom-2 -left-2 sm:-bottom-3 sm:-left-3 bg-green-500 text-white rounded-xl sm:rounded-2xl px-3 sm:px-5 py-2 sm:py-3 shadow-xl"
              >
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              <Link
                href="/products"
                className="group px-6 sm:px-8 py-3 sm:py-4 bg-white text-dark-900 font-semibold rounded-2xl hover:bg-gray-100 transition-all flex items-center justify-center gap-2 text-sm sm:text-lg shadow-2xl shadow-white/10"
              >
                Browse Products
              ...
              <a
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-white/20 text-white font-semibold rounded-2xl hover:bg-white/10 transition-all text-center text-sm sm:text-lg"
              >
                WhatsApp Order
              </a>
            </motion.div>
            ...
            >
              <span className="flex items-center gap-1">
                <Star size={12} className="text-accent-400 fill-accent-400" /> 4.8 Rating
              </span>
              <span className="flex items-center gap-1">
